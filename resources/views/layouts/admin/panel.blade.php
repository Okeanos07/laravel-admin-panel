...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @canany(['urunleri-gorunutuleyebilir', 'siparisleri-gorunutuleyebilir'])
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('urunleri-gorunutuleyebilir')
                            <a class="collapse-item" href="buttons.html">Ürünler</a>
                        @endcan
                        @can('siparisleri-gorunutuleyebilir')
            ...
            @canany(['yazilari-gorunutuleyebilir', 'yazi-kategorilerini-gorunutuleyebilir'])
             ...
             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('yazilari-gorunutuleyebilir')
                            <a class="collapse-item" href="utilities-color.html">Yazılar</a>
                        @endcan

                        @can('yazi-kategorilerini-gorunutuleyebilir')
